...
export default function SignIn() {
	...
	return (
		<div className="w-full sm:w-[26rem] shadow-xl md:shadow-3xl sm:p-5  border dark:border-zinc-800 rounded-md">
...
export const SignOutButton: React.FC = () => {
	  ...
	  if (!isPending) {
		...
		try {
		  ...
		  if (error) {
			...
			router.push('/signin'); // Redirect to login page after signout
		  }
		} catch (error) {
	...
	return (
	  <Button onClick={handleSignOut} disabled={isPending} variant={"ghost"} className="W-full">
